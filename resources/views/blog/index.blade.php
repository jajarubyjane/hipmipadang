            ...
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <button href="#" class="btn btn-outline-light btn-sm"
                        ...
                        <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="https://www.youtube.com/hipmipadang/" target="_blank">
                            <i class="fab fa-youtube fw-normal"></i>
                        </a>

                        <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="https://www.facebook.com/hipmipadang/" target="_blank">
                            <i class="fab fa-facebook-f fw-normal"></i>
                        </a>

                        <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="https://www.instagram.com/hipmipadang/" target="_blank">
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            <a href="{{route('data.blog')}}" class="navbar-brand p-0" style="display: flex; align-items: center;">
                ...
                <p id="hipmi-link" class="navbar-nav" style="font-family: 'Roboto', sans-serif; font-size: 18px; font-weight: 530; line-height: 20px;">
                ...
                <div class="navbar-nav ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="{{route('blog.visimisi')}}" class="dropdown-item" style="font-size: 15px;">Visi dan Misi</a>
                            <a href="{{ route('blog.anggota') }}" style="font-size: 15px;" class="dropdown-item">Struktur Kepengurusan</a>
                        </div>
                    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <p class="mb-4">Sejak 1972, HIPMI Padang membina pengusaha muda untuk berjuang, bukan hanya untuk
                        ...
                        <button class="btn btn-outline-warning"><a href="{{route('blog.sejarah')}}" class="text-dark">Kenali Lebih Dalam</a></button>
                </div>
            ...
            <div class="row g-5">
                        ...
                        ">
                            <div class="team-img position-relative overflow-hidden">
                                ...
                                <div class="team-social">
                                    ...
                                    <a class="btn btn-lg btn-lg-square rounded" style="background: black; color: white" href="{{ $data->instagram }}"
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('blog.anggota') }}" class="btn btn-warning btn-lg rounded-pill">Lihat Semua
                        Anggota <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5 mb-5">
            <div class="bg-white">
                <div class="owl-carousel vendor-carousel">
                    <img src="assets2/img/vendor-1.jpg" alt="">
                    <img src="assets2/img/vendor-2.jpg" alt="">
                    <img src="assets2/img/vendor-3.jpg" alt="">
                    <img src="assets2/img/vendor-4.jpg" alt="">
                    <img src="assets2/img/vendor-5.jpg" alt="">
                    <img src="assets2/img/vendor-6.jpg" alt="">
                    <img src="assets2/img/vendor-7.jpg" alt="">
                    <img src="assets2/img/vendor-8.jpg" alt="">
                    <img src="assets2/img/vendor-9.jpg" alt="">
                </div>
            </div>
        </div>
    </div> --}}
